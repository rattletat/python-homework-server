...
def home_page(request):
    ...
    if request.user.is_authenticated:
        ...
        context['max_points'] = sum(exercise.statistics["test_count"] for exercise in exercises if exercise.relevant)
        context['user_points'] = sum(exercise.statistics["success_count"] for exercise in exercises if exercise.relevant)
